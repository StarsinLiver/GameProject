...
function GameTagStrategy() {
  ...
  useEffect(() => {
    designesis();
    form();
  }, [page, tag, maxPrice, isLikedOrder]);

  useEffect(() => {
    searchByTagName();
  }, [page, pageSize, isLikedOrder]);
  useEffect(() => {
    tagChange(1, tag);
    ...
    <>
      <div className="no-bottom no-top" id="content">
        ...
        <section className="jarallax">
          {/* 백그라운드 이미지 */}
          <img
            src="images/game-wallpaper/18.jpg"
          ...
          <div className="container z-1000" style={{ height: "auto" }}>
            ...
            <div className="row" style={{ height: "auto" }}>
              <div id="" className="wow fadeInRight col-md-9 row g-4 mb-3">
                <>
                  {" "}
                  <div
                    id=""
                  ...
                  >
                    {render &&
                      ...
                      productTag.map((value, index) => (
                        ...
                        >
                          <div className="de-item" style={{ height: "10rem" }}>
...
export default GameTagStrategy;
