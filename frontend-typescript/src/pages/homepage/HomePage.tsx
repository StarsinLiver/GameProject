        ...
        <>
            {render && (
                <div className="no-bottom no-top" id="content">
                    ...
                    <section id="swiper-s2" className="no-top no-bottom position-relative z-1000">
                        <div className="container Z-1000" style={{ padding: '100px 0 0 0' }}>
                            <div className="row align-items-center">
                                <div className="col-lg-6">
                                    <div className="subtitle wow fadeInUp mb-3">Deals Of the Week</div>
                                    <h2 className="wow fadeInUp mb20" data-wow-delay=".2s">
                                        금주의 할인 게임
                                    </h2>
                                </div>
                        ...
                        >
                            ...
                            <div className="swiper-container gallery-top" style={{ height: '600px' }}>
                                {/* <!-- 메인 슬라이드 --> */}
                            ...
                            {/* <!-- 썸네일 슬라이드 --> */}
                            <div className="swiper-container gallery-thumbs" style={{ height: '600px' }}>
                                            ...
                                            .map((value, index) => (
                                                ...
                                                >
                                                    <div className="sw-caption-thumb">
                                                        {value.discount > 0 && (
                                                            <span className="d-tag">{value.discount}% OFF !</span>
                                                        )}
                                                        <h3>{value.name}</h3>
                                                    </div>
                                                </div>
                            ...
                            <div className="row g-0 sequence">
                                ...
                                {render &&
                                    product
                                        ...
                                        .map((value) => (
                                            <>
                                                <div className="col-lg-6 col-sm-6 wow fadeInRight" data-wow-delay="0s">
                    ...
                    <section className="no-bottom" style={{ padding: '50px 0 0 0' }}>
                        <div className="container">
                            <div className="row align-items-center gx-5">
                                ...
                                {/* 랭킹 리스트 시작 */}
                                <div className="container mt-2 wow fadeInRight" data-wow-delay="0s">
                                            ...
                                            <div className="css-1sm2slz">
                                                <div className="css-61xwjr">
                                                    ...
                                                    <Link to={'/games'} className="css-1m37id5">
                                                        <span className="css-15fdr99" style={{ fontWeight: 'bold' }}>
                                                            view more
                                                        </span>
                                                    </Link>
                                                </div>
                            ...
                            <div className="row g-4 sequence">
                                ...
                                {render &&
                                    product.slice(0, 9).map((value, index) => (
                                        <>
                                            <div className="col-lg-4 col-md-4  wow fadeInRight" data-wow-delay="0s">
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-md-12">
                                    <div className="subtitle wow fadeInUp mb-3">Category</div>
                                    <h2 className="wow fadeInUp mb20" data-wow-delay=".2s">
                                        카테고리 바로가기
                                    </h2>
                                </div>
                                    ...
                                    <div className="padding60 sm-padding40 jarallax position-relative">
                                        ...
                                        <div className="row">
                                            <div className="col-lg-6">
                                                ...
                                                <p>
                                                    당사는 모바일 서비스를 진행중 입니다. 더 많은 정보를 얻고 싶다면
                                                    이곳을 통해서 다운로드를 받아주세요!!
                                                </p>
                                ...
                                <div className="col-lg-6">
                                    <div className="row g-4">
                                        <div className="col-sm-2 col-4">
                                            ...
                                            >
                                                <img src="images/payments/toss.png" className="img-fluid" alt="" />
                                            </div>
                                        </div>
                                        <div className="col-sm-2 col-4">
                                            <div
                                        ...
                                        <div className="col-sm-2 col-4">
                                            <div
                                                ...
                                                style={{ width: '90px', height: '90px' }}
                                            >
                                                <img src="images/payments/ssgpay.png" className="img-fluid" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
