...
function AdminControllPenal() {
    ...
    const uploadProduct = (appid: number, uuid: any) => {
        ...
        let data: IProduct = {
            ...
            price: steam?.price_overview ? Math.ceil(((steam?.price_overview[`final`] / 100) * 1300) / 100) * 100 : 0,
            finalPrice: steam?.price_overview
                ? Math.ceil(((steam?.price_overview[`final`] / 100) * 1300) / 100) * 100 * ((100 - discount) / 100)
                : 0,
                                                ...
                                                .map((value, index) => (
                                                    <>
                                                        <tr key={index} style={{ height: '100px' }}>
                                                            ...
                                                            <td className="accordion-header" id={'heading' + index}>
                                                                <a
                                                        ...
                                                        {/* steam details 시작 */}
                                                        <tr>
                                                            <td colSpan={5} style={{ padding: '10px 0 10px 0' }}>
                                                                {/* 콜랩스 자식 */}
                                                                <div
