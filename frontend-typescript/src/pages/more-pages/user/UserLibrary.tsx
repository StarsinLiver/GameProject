...
function UserLibrary() {
    ...
    const [isPasswordChangButton, setIsPasswordChangeButton] = useState<boolean>(false);
    ...
    const reteiveUser = () => {
        UserLibraryService.getAll(user?.userId, page - 1, pageSize)
            .then((response: any) => {
                const { libraryDto, libraryDtoNoPage, qnaList, userDto, totalPages } = response.data;
    ...
    // Todo : 패스워드 바꾸기
    const onClickpasswordChangeButton = (e: React.MouseEvent<HTMLButtonElement>) => {
        e.preventDefault();
        isPasswordChangButton === false ? setIsPasswordChangeButton(true) : setIsPasswordChangeButton(false);
    };
    ...
    const onClickMatchPassword = (e: React.MouseEvent<HTMLButtonElement>) => {
        ...
        AuthService.isPassword(data)
            .then((response: any) => {
                ...
                response.data ? alert('바꾸실 패스워드를 입력해주세요') : alert('패스워드가 잘못되었습니다.');
                    ...
                    <div className="container">
                        <div className="row">
                                ...
                                <div id="blog-comment">
                                    <li>
                                        ...
                                        <div className="avatar">
                                            <img src={require('../../../assets/images/people/1.jpg')} alt="" />
                                        </div>
                                        ...
                                        <form name="contactForm" id="contact_form" className="form-border">
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-lg-6 offset-lg-3">
                                                    <div className="title-line">Under&nbsp;line&nbsp;╰(*°▽°*)╯</div>
                                                </div>
                                            </div>
                                        </form>
                                    </>
                                ...
                                <section className="no-top ">
                                    <div className="container">
                                        <div className="row align-items-center">
                                            <div className="col-lg-6">
                                                <div className="subtitle wow fadeInUp mb-3">Library</div>
                                        ...
                                        <div className="row g-4 sequence">
                                            {libraryDto.map((value: any, index: any) => (
                                                <div className="col-lg-4 col-sm-6 gallery-item" key={index}>
                                                    <div
                                                        className="de-item wow"
                                                        style={{
                                                            border: showRefundButton ? '3px solid red' : 'none',
                                        ...
                                        {libraryDto[0] == null && (
                                            <div className="row g-4 sequence">
                                                ...
                                                <a className="btn-main float-end me-5 col-md-3" href="/games">
                                                    게임 보러 가기
                                                </a>
                                            </div>
                                        )}
                            ...
                            <div id="sidebar" className="col-md-4 mt-5">
                                ...
                                <div className="widget widget-post">
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <a href="#">{userDto.point && userDto.point.toLocaleString()} 원 </a>
                                        </li>
                                    </ul>
                                </div>
                                {/* 나의 포인트 내역 끝 */}
                                    ...
                                    <div className="modal-dialog">
                                        <div className="modal-content">
                                            ...
                                            >
                                                ...
                                                >
                                                    {/* 이전 월로 이동 버튼 */}
                                                    <button onClick={moveToPreviousMonthBuy} className="btn-main me-3">
                                                        &lt;&lt;
                                                    </button>
                                                    ...
                                                    {/* 다음 월로 이동 버튼 */}
                                                    <button onClick={moveToNextMonthBuy} className="btn-main ms-3">
                                                        &gt;&gt;
                                                    </button>
                                                </div>
                                                        ...
                                                        .map((value: any, index: any) => (
                                                            <React.Fragment key={index}>
                                                                <li>
                                                                    ...
                                                                    {value.finalPrice} 원<a href="#">{value.pname}</a>
                                                                </li>
                                                            </React.Fragment>
                                                        ))}
                                                </div>
                                ...
                                {/* QNA 시작 */}
                                <div className="widget widget-post">
                                    <Link className="btn-main float-end me-5" to={`/user-qna-list`}>
                                        Q & A
                                    </Link>
                                    <h4>Q & A</h4>
                                    <div className="small-border"></div>
                                ...
                                {/* 환불 내역 시작 */}
                                <div className="widget widget-post">
                                    <Link className="btn-main float-end me-5" to={``} onClick={handleRefundButtonClick}>
                                                ...
                                                <>
                                                    {value.requestRefund === 'Y' && (
                                                        <li>
                                                            ...
                                                            <Link to={`/user-refund/${value.lid}`}>{value.pname}</Link>
                                                        </li>
                                                    )}
                                                </>
                                            ))}
                                        ...
                                        <div className="modal-dialog">
                                            <div className="modal-content">
                                                ...
                                                <div className="modal-body" style={{ whiteSpace: 'pre' }}>
                                                    ...
                                                    <div className="widget widget-post" style={{ listStyle: 'none' }}>
                                                        {libraryDtoNoPage &&
                                                            libraryDtoNoPage
                                                                .filter((value: any) => value.requestRefund === 'Y')
                                                                .filter(
                                                                    (value: any) =>
                                ...
                                <div className="widget widget-text">
                                    ...
                                    <p className="small no-bottom">
                                        환불한 게임은 다시 그 가격에 구매하지 못할수도 있습니다. <br /> 일부 게임은
                                        환불이 불가합니다. <br /> 추가적인 문의사항은 Q&A를 이용해주세요.
                                    </p>
                                </div>
                                {/* 주의 사항 끝 */}
