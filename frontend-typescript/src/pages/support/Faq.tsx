              ...
              <div className="col-lg-6">
                <div className="accordion s2 wow fadeInUp">
                  <div className="accordion-section">
                    ...
                    >
                      <p>
                        상품 목록을 확인하신 후, 구매가 완료되면 고객님의
                        이메일로 즉시 사용 가능한 게임 키를 보내드립니다. <br />
                        <br /> 해당 키를 본인이 사용하는 게임 플랫폼에
                        등록해주시면 됩니다.
                      </p>
                    </div>
                    <div
                    ...
                    >
                      <p>
                        게임을 구매하시면 게임 가격의 일부를 포인트로 적립
                        받으실 수 있습니다. <br />
                        <br /> 적립된 포인트는 추후 다른 게임을 구매하실 때,
                        할인 수단으로 활용하실 수 있습니다.
                      </p>
                    </div>
                    <div
                    ...
                    >
                      <p>
                        유저 본인의 라이브러리 페이지에 들어가시면, <br /> 내가
                        한 질문의 목록과 답변 여부 및 답변 내용 등을 확인하실 수
                        있습니다.
                      </p>
                    </div>
                    <div
                    ...
                    >
                      <p>
                        유저 라이브러리 페이지에서 구매한 게임에 대한 환불을
                        진행하실 수 있습니다. <br />
                        <br /> 환불 요청은 관리자에게 전송되며, 환불 불가 사유에
                        위배 되지 않는 한, 확인 즉시 처리됩니다.
                      </p>
                    </div>
                    <div
                      className="accordion-section-title"
                  ...
                  <div className="accordion-section">
                    ...
                    >
                      <p>
                        ...
                        <br /> 액션, RPG, 시뮬레이션 등, 다양한 장르의 게임을
                        한눈에 볼 수 있게 정리된 페이지가 존재합니다.
                      </p>
                    </div>
                    <div
                      className="accordion-section-title"
                    ...
                    >
                      <p>
                        당사에서는 고객님의 요청을 이메일 메세지를 통해 전달받고
                        있습니다. <br />
                        <br /> 스토어 이용 간 궁금한 점이 있다면 자유롭게
                        말씀해주세요.
                      </p>
                    </div>
                    <div
                    ...
                    >
                      <p>
                        당사의 게임 할인 이벤트는 일정과 수량에 맞춰 진행되고
                        있습니다. <br />
                        <br /> 일정 상 마감되거나, 물량이 소진된다면 할인
                        이벤트는 조기에 종료될 수 있습니다.
                      </p>
                    </div>
                    <div
                    ...
                    >
                      <p>
                        페이지 상단부의 뉴스 페이지를 통해 새롭게 출시되는 게임
                        및 게임 업계에서 이슈가 된 새로운 소식들을 확인하실 수
                        있습니다.
                      </p>
                    </div>
                  </div>
